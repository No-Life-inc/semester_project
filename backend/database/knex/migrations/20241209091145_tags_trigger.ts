  ...
  await knex.schema.raw(`
    ...
    BEGIN
      ...
      BEGIN
        ...
        VALUES ('tags', @operation_type, @record_id, GETDATE());
      END
    END;
  `);

  await knex.schema.raw(`DISABLE TRIGGER trg_tags_audit ON tags;`);
}

export async function down(knex: Knex): Promise<void> {
  await knex.schema.raw(`DROP TRIGGER IF EXISTS trg_tags_audit;`);
}
