  ...
  await knex.schema.raw(`
    ...
    BEGIN
      ...
      BEGIN
        ...
        VALUES ('collections', @operation_type, @record_id, GETDATE());
      END
    END;
  `);

  await knex.schema.raw(`DISABLE TRIGGER trg_collections_audit ON collections;`);
}

export async function down(knex: Knex): Promise<void> {
  await knex.schema.raw(`DROP TRIGGER IF EXISTS trg_collections_audit;`);
}
