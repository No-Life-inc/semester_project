...
//     it("should add a book to a user", async () => {
//         const userBook = await addBookToUser(2, 1);
//         expect(userBook).toBeDefined();
//       });

//     it("should add a book to a user", async () => {
//         const userBook = await addBookToUser(100, 3);
//         expect(userBook).toBeDefined();
//       });

//     it("should add a book to a user", async () => {
//         const userBook = await addBookToUser(99, 3);
//         expect(userBook).toBeDefined();
//       });

//     it("should add a book to a user", async () => {
//         const userBook = await addBookToUser(50, 2);
//         expect(userBook).toBeDefined();
//       });
//   });