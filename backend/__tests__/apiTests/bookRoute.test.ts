...
describe('Book Routes - Get Books  Positive tests', () => {
  ...
  test.each([
    ...
    ["should get 1 books on page 99", "/book/?page=99&limit=1", 200, Array.isArray, 1],
...
describe('Book Routes - Get Books Negative tests', () => {
  ...
  test.each([
    ["should get 0 books", "/book/?limit=0", 422],
    ["should get 0 books", "/book/?limit=-1", 422],
    ["should get 0 books", "/book/?limit=-2", 422],
    ["should get 0 books", "/book/?limit=101", 422],
    ["should get 0 books", "/book/?limit=102", 422],
    ["should get 0 books", "/book/?page=0", 422],
    ["should get 0 books", "/book/?page=-1", 422],
    ["should get 0 books", "/book/?page=-2", 422],
    ["should get 0 books", "/book/?page=a", 422],
    ["should get 0 books", "/book/?limit=a", 422],
    ["should get 0 books", "/book/?limit= ", 422],
    ["should get 0 books", "/book/?page= ", 422],
  ])(
    "%s", 
...
describe('Book Routes - Get Book By ID Negative tests', () => {
  ...
  test.each([
    ["should get 422 for invalid ID", "/book/id/0", 422],
    ["should get 422 for invalid ID", "/book/id/-1", 422],
    ["should get 422 for invalid ID", "/book/id/-2", 422],
    ["should get 404 for invalid ID", "/book/id/101", 404],
    ["should get 404 for invalid ID", "/book/id/102", 404],
    ["should get 422 for invalid ID", "/book/id/a", 422],
...
describe('Book Routes - Search Books Negative tests', () => {
  ...
  test.each([
    ["should get 0 books by title", "/book/search?title=", 422],
    ["should get 0 books by title", `/book/search?title=${"A".repeat(256)}`, 500],
    ["should get 0 books by title", `/book/search?title=${"A".repeat(255)}`, 500],
  ])( 
    "%s",
    async (description, route, expectedStatus) => {
      const response = await request(app).get(route);
